...
// /* "proxy":"http://192.168.134.64:4000" */
//   const texttrans = async (text, to)=>{
//     axios.get(`/texttranslate?sourceText=${input}&targetLanguage=${To}`
//     ).then((res)=>{
//       console.log(res);
...
//       <span style={{fontWeight:600}}>Translate Text To ({To}): </span>
//         <select onChange={(e)=> setTo(e.target.value)}>
//             {options.map((data)=><option key={data.code} value={data.code} style={{fontWeight:400}}>{data.name}</option>)}
//         </select>

//       </div>
//       <div>
//         <textarea style={{borderRadius: "15px",borderRadiusColor:"darkgrey", 
//         borderBlockWidth:"10px", fontWeight:700,backgroundColor:"silver"}}
//         cols="80" rows="10" onInput={(e)=>setInput(e.target.value)} placeholder="write your original text here..."></textarea>
//       </div>
//       <div>
//         <button style={{width:"150px", height:"30px",borderRadius: "10px",
//          borderBlockWidth:"6px",color:"" ,fontWeight:700,backgroundColor:"lightpink"}} onClick={texttrans}>Translate Text</button>
//       </div>
//       <div>
//       <textarea style={{borderRadius: "15px",borderRadiusColor:"darkgrey", 
//         borderBlockWidth:"10px", fontWeight:700,backgroundColor:"silver"}} 
//         cols="80" rows="10" value={output}placeholder="translated text ..." ></textarea>
//       </div>
